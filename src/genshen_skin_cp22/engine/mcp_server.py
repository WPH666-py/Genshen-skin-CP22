# -*- coding: utf-8 -*-
"""
原神 CP 壁纸套件 22 —— MCP (Model Context Protocol) 服务器
...
注册示例(任选其一):
  claude mcp add genshen-cp22 -- genshen-cp22-mcp
  # 或写入 .mcp.json / mcp_servers.json:
  {"mcpServers": {"genshen-cp22": {"command": "genshen-cp22-mcp", "args": []}}}
...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "out_dir": {"type": "string", "description": "输出目录, 默认 ~/.genshen-cp22/wallpapers"},
