...
背景
----
CP1(Genshen-Skin-CP1 · 荧×达达利亚)先做出来, 引擎代码直接放在
...
PACKS = {
    ...
    "CP18": {
        "repo": os.path.join(WORKSPACE, "Genshen-skin-CP18"),
        "pkg": ("Genshen-skin-CP18", "src", "genshen_skin_cp18"),
        "flat": False,
        "slug": "genshen_skin_cp18",
    },
    "CP19": {
        "repo": os.path.join(WORKSPACE, "Genshen-skin-CP19"),
        "pkg": ("Genshen-skin-CP19", "src", "genshen_skin_cp19"),
        "flat": False,
        "slug": "genshen_skin_cp19",
    },
    "CP20": {
        "repo": os.path.join(WORKSPACE, "Genshen-skin-CP20"),
        "pkg": ("Genshen-skin-CP20", "src", "genshen_skin_cp20"),
        "flat": False,
        "slug": "genshen_skin_cp20",
    },
    "CP21": {
        "repo": os.path.join(WORKSPACE, "Genshen-skin-CP21"),
        "pkg": ("Genshen-skin-CP21", "src", "genshen_skin_cp21"),
        "flat": False,
        "slug": "genshen_skin_cp21",
    },
    "CP22": {
        "repo": os.path.join(WORKSPACE, "Genshen-skin-CP22"),
        "pkg": ("Genshen-skin-CP22", "src", "genshen_skin_cp22"),
        "flat": False,
        "slug": "genshen_skin_cp22",
    },
}
...
def _role_of(key):
    ...
    return {"CP2": "odette_voj", "CP3": "cp3_trio",
            ...
            "CP15": "cp15_pair", "CP16": "cp16_pair", "CP17": "cp17_quartet", "CP18": "cp18_pair", "CP19": "cp19_pair", "CP20": "cp20_pair", "CP21": "cp21_pair",
            "CP22": "cp22_pair"}.get(key)
...
def normalize(text, src_slug, dst_slug, dst_key=None, src_key=None, src_repo=None,
    ...
    还要改写「常量模块」的导入, 各套件结构不同:
      ...
      CP4: from ..characters import cp22_pair as C
    ...
    CN = {
        "CP1": ("原神 CP 壁纸套件 1", "原神CP1", "荧 × 达达利亚", "~/.genshin-cp1"),
        "CP2": ("原神 CP 壁纸套件 2", "原神CP2", "荧 × 达达利亚", "~/.genshen-cp2"),
        "CP3": ("原神 CP 壁纸套件 3", "原神CP3", "荧 × 达达利亚", "~/.genshen-cp3"),
        "CP4": ("原神 CP 壁纸套件 22", "原神CP22", "荧 × 达达利亚", "~/.genshen-cp22"),
    }
    ...
    # 注意: 源与目标的角色模块名可能不同(cp22_pair vs odette_voj),
